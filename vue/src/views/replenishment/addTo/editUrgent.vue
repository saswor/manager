    ...
    <div class="block-warp">
            ...
            <div class="search-warp">
                  ...
                  <el-row class="row-top">
                    ...
                    <el-col :span="12">
                        <el-input placeholder="输入规则：0-30" class="levelStyle" v-model="addForm.fristlevel"  size="medium" clearable>
                          </el-input>
                          <el-input placeholder="输入规则：31-60" class="levelStyle" v-model="addForm.twolevel"  size="medium" clearable>
                          </el-input>
                          <el-input placeholder="输入规则：61-100" class="levelStyle" v-model="addForm.threelevel"  size="medium" clearable>
                          </el-input>
                          <div style="color:#F56C6C; line-height:16px; font-size:12px;">
                          库存划分必须以0开始,100结束,中间两级连接的地方必须
                          </div>
                    </el-col>
                  </el-row>
                  <el-row class="row-top">
    ...
    addSubmitForm(formName) {//提交新增窗口
      this.$confirm('确认提交吗？', '提示', {}).then(() => {
        let para = Object.assign({}, this.addForm);
         ...
         para.supplyId = this.$route.query.supplyId
       ...
       const listQuery = {
        ...
        getSupplyOrderDetail(listQuery).then(response => {
          if(response.zhead.reTCode==="0000"){
            ...
            _this.addForm.strategy = eval('(' + _this.addForm.strategy + ')')
