...
/**
 * 优惠对象列，在下单的时候可通过此方便查询优惠对象的优惠，需根据《优惠 3.2.4.1》和《优惠时间段3.2.4.2》定时更新此，此保存对象的最新优惠。根据优惠时间段更新此最新优惠 服务层
 * 
 * @author xufeng
 * @date 2018-08-31
 */
public interface IFavourableObjectService 
{
	/**
	...
	/**
     * 删除优惠对象列，在下单的时候可通过此方便查询优惠对象的优惠，需根据《优惠 3.2.4.1》和《优惠时间段3.2.4.2》定时更新此，此保存对象的最新优惠。根据优惠时间段更新此最新优惠信息
     * 
     * @param ids 需要删除的数据ID
     * @return 结果
     */
	 ...
	 * @return
	 */
	public List<FavourableObject> selectFavourableSiteList(String favourableId,String districtId, String lineId, String favObjId, String corpId);
