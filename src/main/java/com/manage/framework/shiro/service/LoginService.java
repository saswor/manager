package com.manage.framework.shiro.service;
...
import com.manage.common.constant.ShiroConstants;
...
import com.manage.common.utils.SystemLogUtils;
import com.manage.common.utils.security.ShiroUtils;
import com.manage.project.system.base.domain.User;
import com.manage.project.system.base.domain.UserStatus;
...
//        {
//            user = userService.selectUserByPhoneNumber(username).get(0);
//        }
//
...
//        }
        ...
        if (user == null || (!UserStatus.OK.getCode().equals(user.getDelFlag())))
        {
