 ...
 <div class="div-warp">
      <el-card class="box-card">
        ...
        <el-form :model="addForm" :rules="Rules" class="formWidth" ref="addForm" @submit.prevent="onSubmit" >
          <el-form-item label="商户编号" prop="corpName" size="small" :label-width="formLabelWidth">
            <el-input v-model="addForm.corpId" auto-complete="off" disabled></el-input>
          </el-form-item>
...
<script>
import {editCorp} from '@/api/systemSetup'
