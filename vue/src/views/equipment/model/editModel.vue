    ...
    <el-form :model="addForm" :rules="Rules"  ref="addForm" @submit.prevent="onSubmit">
      <el-card class="box-card">
        <div slot="header" class="clearfix">
          ...
          <el-form-item label="厂家" prop="factoryId" size="small" :label-width="formLabelWidth">
            <el-select v-model="addForm.factoryId" @change="getCabinetType(addForm.factoryId,'slect')" size="small" placeholder="请选择厂家">
              <el-option
      ...
      <el-card class="box-card top-20">
        ...
        <el-row>
          ...
          <el-col :span="16">
            <!-- 货道配置列表 -->
          <el-row type="flex" style="width:740px; margin:auto;" justify="center" v-show="hdVisible" v-for="item in rowValue">
...
<script>
import { getMachineSelect,editVendingModel } from '@/api/equipment'
...
export default {
    ...
    addSubmitForm(formName) {//提交新增窗口
        this.$refs[formName].validate((valid) => {
          ...
          this.$confirm('确认提交吗？', '提示', {}).then(() => {
                  ...
                  editVendingModel(para).then((res) => {
  ...
  mounted () {
        ...
        this.getCabinetType(this.addForm.factoryId,"edit")
  },
  components: {
