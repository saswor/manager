 ...
 <div class="div-warp">
      <div class="search-warp">
        <el-row :gutter="20" >
            ...
            <el-col :span="3" v-if="searchObj.reportType==4">
                <el-select size="small" v-model="searchObj.quarter" clearable  placeholder="请选择季度">
                  <el-option
                    key="1"
                    label="第一季度"
                    value="1">
            ...
            <el-col :span="3" v-if="searchObj.reportType==5">
                <el-select size="small" v-model="searchObj.halfYear" clearable  placeholder="请选择上/下半年">
                  <el-option
                    key="1"
                    label="上半年"
                    value="1">
...
export default {
  ...
  methods: {
     ...
     timeType(){
        this.searchObj.date="";
        this.searchObj.quarter='';
        this.searchObj.halfYear='';
     },
