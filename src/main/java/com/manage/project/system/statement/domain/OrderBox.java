 ...
 * @title OrderBox
 * @description TODO
 * @time 2019年1月17日上午9:03:55
 */
public class OrderBox extends BaseEntity{
	
	private static final long serialVersionUID = -1182393814134924684L;
	/**
	 * 记录编号
	 */
	...
	/**矫正状态名称*/
	private String correctStateName;
	...
	public String getCorrectStateName() {
		return correctStateName;
	}
	public void setCorrectStateName(String correctStateName) {
		this.correctStateName = correctStateName;
	}
