...
import com.manage.framework.shiro.web.filter.ShiroFormAuthenticationFilter;
...
public class ShiroConfig
{
    ...
    {
        net.sf.ehcache.CacheManager cacheManager = net.sf.ehcache.CacheManager.getCacheManager("manage");
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        filterChainDefinitionMap.put("/system/ajaxLogout", "anon");
        filterChainDefinitionMap.put("/login.html", "anon");
        filterChainDefinitionMap.put("/captcha/captchaImage**", "anon");
        filterChainDefinitionMap.put("/interface", "anon");	// 访问接口时不用登录
        filterChainDefinitionMap.put("/static/**", "anon");	// vue使用
        filterChainDefinitionMap.put("/log.ico", "anon");	// 前端使用        
        filterChainDefinitionMap.put("/index.html", "anon");	// 首页
        filterChainDefinitionMap.put("/receivePayResult", "anon");	// 接收服务器推送的支付配置测试结果
        filterChainDefinitionMap.put("/system/cache/getCache", "anon");	// 服务器查询缓存接口
        filterChainDefinitionMap.put("/system/cache/putCache", "anon");	// 服务器修改缓存接口       
        filterChainDefinitionMap.put("/system/payConfig/receiveResult", "anon");	// 服务器修改缓存接口
        filterChainDefinitionMap.put("/system/logfile/upload", "anon");	// 日志上传接口
        // 退出 logout地址，shiro去清除session
        filterChainDefinitionMap.put("/logout", "logout");
        filterChainDefinitionMap.put("/interface/**", "anon");	// 接收对外接口地址
        ...
        filters.put("onlineSession", new ShiroFormAuthenticationFilter(this.loginUrl));
