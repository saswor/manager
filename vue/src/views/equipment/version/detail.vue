      ...
      <el-card class="box-card">
        <div slot="header" class="clearfix">
          ...
          <el-form-item label="系统类型" size="small" :label-width="formLabelWidth">
            <el-input v-model="addForm.salePrice" :disabled="true" class="inputStyle" ></el-input>
          </el-form-item>
          ...
          <el-form-item label="网络类型" size="small" :label-width="formLabelWidth">
            <el-input v-model="addForm.netStateName" :disabled="true" class="inputStyle" ></el-input>
          </el-form-item>
          ...
          <el-form-item label="屏幕类型" size="small" :label-width="formLabelWidth">
            <el-input v-model="addForm.screenType" :disabled="true" class="inputStyle" ></el-input>
          </el-form-item>
