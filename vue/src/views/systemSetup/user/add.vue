      ...
      <el-card class="box-card">
        ...
        <el-form :model="addForm" :rules="Rules" class="formWidth" ref="addForm" @submit.prevent="onSubmit" >
          <el-form-item label="登录名称" prop="loginName" size="small" :label-width="formLabelWidth">
            <el-input v-model="addForm.loginName" auto-complete="off" placeholder="登录名以字母或数字组成，示例：lihao"></el-input>
          </el-form-item>
          ...
          <el-form-item label="密码" prop="password"  size="small" :label-width="formLabelWidth">
            <el-input v-model="addForm.password" type="password" auto-complete="off" placeholder="密码必须由6-12位的字母和数字组成，示例: zhilai123"></el-input>
          </el-form-item>
    ...
    getRole(page) {
      ...
      getRoleList(listQuery).then(response => {
         if(response.zhead.reTCode==="0000"){
          ...
          console.log("user："+this.addForm.userName)
         }else{
             this.$notify({
              title: '失败',
              message: res.zhead.retMsg,
