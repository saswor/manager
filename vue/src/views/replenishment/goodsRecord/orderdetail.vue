    ...
    <div id="printTest" style="overflow:hidden">
        <div class="block-warp">
           <div class="tit" style="margin-bottom:20px;">补货记录信息</div>
              <el-form :model="supplyOrder"  label-width="150px" :label-position="labelPosition" :inline="true"  ref="supplyOrder" >
              <el-form-item label="补货编号：" size="small"  :label-width="formLabelWidth">
                <el-input v-model="supplyOrder.sOrderId" :readonly="true" auto-complete="off"></el-input>
                <!-- <span>{{supplyOrder.sOrderId}}</span> -->
              </el-form-item>
              <el-form-item label="完成时间：" size="small"  :label-width="formLabelWidth">
                <el-input v-model="supplyOrder.supplyFTime" :readonly="true" auto-complete="off"></el-input>
                <!-- <span>{{supplyOrder.supplyFTime}}</span> -->
              </el-form-item>
              <el-form-item label="线路编号：" size="small"  :label-width="formLabelWidth">
                <el-input v-model="supplyOrder.lineId" :readonly="true" auto-complete="off"></el-input>
                <!-- <span>{{supplyOrder.lineId}}</span> -->
              </el-form-item>
              <el-form-item label="线路名称："  size="small" :label-width="formLabelWidth">
                <el-input v-model="supplyOrder.lineName" :readonly="true" auto-complete="off"></el-input>
               <!-- <span>{{supplyOrder.lineName}}</span> -->
              </el-form-item>
              <el-form-item label="仓库编号：" size="small" :label-width="formLabelWidth">
                <el-input v-model="supplyOrder.wmId" :readonly="true" auto-complete="off"></el-input>
                <!-- <span>{{supplyOrder.wmId}}</span> -->
              </el-form-item>
              <el-form-item label="仓库名称：" size="small"  :label-width="formLabelWidth">
                <el-input v-model="supplyOrder.wmName" :readonly="true" auto-complete="off"></el-input>
                <!-- <span>{{supplyOrder.wmName}}</span> -->
              </el-form-item>
             
              <el-form-item label="补货员名：" size="small"  :label-width="formLabelWidth">
                <el-input v-model="supplyOrder.supplierName" :readonly="true" auto-complete="off"></el-input>
                <!-- <span>{{supplyOrder.supplierName}}</span> -->
              </el-form-item>
              <el-form-item label="补货站点数量："  size="small"  :label-width="formLabelWidth">
                <el-input v-model="supplyOrder.num" :readonly="true" auto-complete="off"></el-input>
                <!-- <span>{{supplyOrder.num}}</span> -->
              </el-form-item>
              <el-form-item label="需补货总数："  size="small"  :label-width="formLabelWidth">
                <el-input v-model="supplyOrder.supplyNum" :readonly="true" auto-complete="off"></el-input>
                <!-- <span>{{supplyOrder.supplyNum}}</span> -->
              </el-form-item>
              <el-form-item label="实补货总数："  size="small"  :label-width="formLabelWidth">
                <el-input v-model="supplyOrder.rSupplyNum" :readonly="true" auto-complete="off"></el-input>
                <!-- <span>{{supplyOrder.rSupplyNum}}</span> -->
              </el-form-item>
              <el-form-item label="补货类型：" prop="typeName" size="small"  :label-width="formLabelWidth">
                <el-input v-model="supplyOrder.typeName" :readonly="true" auto-complete="off"></el-input>
                <!-- <span>{{supplyOrder.typeName}}</span> -->
              </el-form-item>
            </el-form>
        </div>
        <div class="block-warp">
...
<script>
import { supplyOrderDetail,exportSupplyOrderDetail} from '@/api/replenishment'
  ...
  methods: {
    //导出补货单详情
      exportExcel(){
        ...
        exportSupplyOrderDetail(para).then((res) => {
              if(res.zhead.reTCode=="0000"){
                window.location.href=this.ImgUrl+res.zhead.retMsg
              }else{
                this.$notify({
                  title: '失败',
    ...
    getSupplyOrderDetailData(){
      ...
      supplyOrderDetail(listQuery).then(response => {
         if(response.zhead.reTCode==="0000"){
            ...
            _this.supplyOrder = response.zbody.datas.supplyOrder;
